  ...
  return (
    <>
      <header className="layout">
        <div className="flex items-center gap-3" onClick={() => router.push("/Staff/Dashboard")} style={{ cursor: "pointer" }}>
          <img src="/logo-dlsud.png" alt="DLSU-D Logo" className="w-10 h-10 object-contain" />
          <h1 className="text-base sm:text-lg font-semibold site-title">BFMO Report System</h1>
        </div>
        <HeaderNav />
