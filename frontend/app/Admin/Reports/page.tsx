...
export default function ReportPage() {
  ...
  const handleCreateTask = async () => {
    ...
    // Auto-add any pending staff input before saving
    const finalStaff = [...taskStaff];
    if (taskStaffInput.trim() && !finalStaff.includes(taskStaffInput.trim())) {
      finalStaff.push(taskStaffInput.trim());
    }
      ...
      <div className="report-modal" onClick={e => e.stopPropagation()}>
        <div className="modal-header">
          ...
          <div className="modal-header-actions">
            ...
            <button type="button" className="modal-create-task-btn" onClick={() => { closeDetails(); openCreateTask(selectedReport); }} title="Create a task from this report">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="modal-content">
          <div className="modal-img-wrapper">
            <img src={resolveImageFile(selectedReport.ImageFile || selectedReport.image)} alt="Report"
